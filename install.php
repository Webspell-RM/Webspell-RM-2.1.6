...
$transaction .= add_table("CREATE TABLE IF NOT EXISTS`" . PREFIX . "settings_plugins_widget` ( 
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `modulname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `widgetname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `widgetdatei` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
